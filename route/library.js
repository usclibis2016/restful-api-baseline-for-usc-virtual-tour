...
router.post('/',upload.single("panoramic_view"), (req, res) => {
    ...
    const newLibrary = new Library({library_name,library_description,library_location,librarian});
    newLibrary.save()
...
router.route('/update/:id').post((req, res) => {
    ...
    .then( library=> {
                    ...
                    library.library_location = req.body.library_location;
                    library.librarian = req.body.librarian;
                    library.save()
